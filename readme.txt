...
---------------------------------------------------------------- Bestehende Probleme --------------------------------------------------------------------------------------
Funktioniert nur auf der Domäne "http://vm10060/", kann aber in der Manifest-Datein "manifest.json" unter "content_scripts" - "matches" geändert werden.
...
<a>-HTML-Tags haben ein eigenes Context-Menü, in dem der KnockoutInfo eintrag nicht erscheint. Die Extension ist also nicht auf Links anwendbar.